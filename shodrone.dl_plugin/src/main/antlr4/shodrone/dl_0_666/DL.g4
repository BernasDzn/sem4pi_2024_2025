...
declaration:
    POINT ID EQUALS expression SEMICOLON
...
moveCircle:
    'moveCircle' LP expression COMMA expression COMMA expression RP SEMICOLON
    | 'moveCircle' LP expression COMMA intExpression COMMA expression RP SEMICOLON
;
...
lightsOn:
    'lightsOn' LP COLOR RP SEMICOLON
;
...
// Colors
COLOR: 'RED' | 'GREEN' | 'BLUE' | 'YELLOW' | 'PURPLE' | 'ORANGE' | 'PINK' | 'WHITE';
